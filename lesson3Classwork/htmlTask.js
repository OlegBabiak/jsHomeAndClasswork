...
for (let simpson of simpsons) {
    document.write(`<div>${simpson.name} ${simpson.surname} ${simpson.surname} ${simpson.age} ${simpson.info} </br> <img style="width: 300px" src="${simpson.photo}" alt="${simpson.name}"></div>`)
}
...
document.write(`<div>`);
for (let simpson of simpsons) {
    document.write(`<div><h2>${simpson.name} ${simpson.surname} age is - ${simpson.age}</h2><p>${simpson.info}</p> <img style="width: 300px" src="${simpson.photo}" alt="${simpson.name}"</div>`)
}
document.write(`</div>`);
...
document.write(`<div class="product-card">`)
    document.write(`<h3 class="product-title">${product.title}. Price - ${product.price}</h3> <img style="width: 200px" src="${product.image}" alt="${product.title}"`)
document.write(`</div>`)
}
document.write(`</div>`)